...
namespace YHGE {
    ...
    template <class T> inline std::ostream& operator<<(std::ostream& out, const YHGE::vec2g<T>& v) {
        return out << v.x << "  " << v.y;
    }

    template <class T> inline std::istream& operator>>(std::istream& in, YHGE::vec2g<T>& v) {
        return in >> v.x >> v.y;
    }

    template <class T> inline std::ostream& operator<<(std::ostream& out, const YHGE::vec3g<T>& v) {
        return out << "( " << v.x << " , " << v.y << " , " << v.z << " )";
    }

    template <class T> inline std::istream& operator>>(std::istream& in, YHGE::vec3g<T>& v) {
        return in >> v.x >> v.y >> v.z;
    }

    template <class T> inline std::ostream& operator<<(std::ostream& out, const YHGE::vec4g<T>& v) {
        return out << v.x << "  " << v.y << "  " << v.z << " " << v.w;
    }

    template <class T> inline std::istream& operator>>(std::istream& in, YHGE::vec4g<T>& v) {
